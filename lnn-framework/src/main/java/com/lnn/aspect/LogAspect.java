package com.lnn.aspect;

import com.alibaba.fastjson.JSON;
import com.lnn.annotation.SystemLog;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.lnn.annotation.SystemLog)")
    public void pt(){
    }
    ...
    private void handleBefore(ProceedingJoinPoint proceedingJoinPoint) {
        ...
        log.info("Class Method   : {}.{}", proceedingJoinPoint.getSignature().getDeclaringType(),((MethodSignature) proceedingJoinPoint.getSignature()).getName());
        // 打印请求的 IP
